...
<html lang="en">
  <head>
    ...
    <main>
      ...
      <h3>Server</h3><p><br>
        I run two compute servers. Both are HPE ProLiant DL380p G8 servers. One is a SFF variant, one is a LFF variant. I have one (the LFF version; "eclipse") configured with a raw capacity of 2TB storage. My boot drives are on the intergrated P420 raid controller. I have two Xeon E5-2650's (total of 16 cores, 32 threads at 2.8GHz), 128GB ram. The data storage is on my other server; frontier. Frontier is a server that's hacked together and runs a Xeon E5-2650 v4, 128GB ECC Reg DDR4 and a GTX 1050 for Jellyfin purposes. Frontier runs NixOS. The other (the SFF version; "permafrost") server is built with 96GB ram,two Xeon E5-2630's (total of 12 cores, 24 threads at 2.3GHz) and 2x 146GB of SAS 15k RPM HDD drives in a mirror as it's plenty for my install. This will probably be upgraded to a RAID1 array with two SSD's, because I use this server for VMs specifically. As for Setup: all of my servers run Proxmox GNU/Linux except for my VMs, which run Debian.</p>
        <br>
      </div>
      <br>
      <div class="body">
